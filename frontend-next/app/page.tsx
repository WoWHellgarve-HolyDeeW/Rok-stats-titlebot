        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="card p-6">
            <Link href="/compare" className="hover:underline">
              <h3 className="font-bold text-lg mb-2">⚔️ Player Comparator</h3>
            </Link>
            <p className="text-text-muted text-sm">Compare 2-6 governors side-by-side with all kill tiers, deaths, economy stats.</p>
          </div>
        </div>
      </section>
