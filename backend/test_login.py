...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        print("Exemplo: python test_login.py 0000 <password>")
        print("Exemplo: python test_login.py 0000 <password> http://localhost:8000")
        print("Exemplo: python test_login.py 0000 <password> http://127.0.0.1/api your-domain.example.com")
        sys.exit(1)
